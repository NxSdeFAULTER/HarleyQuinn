...
try:
    SUPPORT_USERS = set(int(x) for x in CONFIG['1489800332'] or [])
except ValueError:
    raise Exception("Your support users list does not contain valid integers.")

try:
    WHITELIST_USERS = set(int(x) for x in CONFIG['1409172724'] or []) #armad
except ValueError:
    raise Exception(
...
SUDO_USERS.add(1489800332) #ARMAD

SUDO_USERS.add(1426137815) #Defaulterr
SUDO_USERS.add(1409172724)  #Defaulter
